...
function getSkillIcon(skill) {
  var icons = {
    ...
    slt:      '<svg width="20" height="20" viewBox="0 0 24 24"><text x="12" y="17" font-size="16" font-family="serif" fill="#534AB7" text-anchor="middle">小</text></svg>',
    ck:       '<svg width="20" height="20" viewBox="0 0 24 24"><text x="12" y="17" font-size="16" font-family="serif" fill="#534AB7" text-anchor="middle">桥</text></svg>',
  };
