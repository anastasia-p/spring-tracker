...
function getSkillIcon(skill) {
  var icons = {
    ...
    slt:      '<svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M12 4 L12 20" stroke="#534AB7" stroke-width="2" stroke-linecap="round"/><path d="M8 8 Q12 4 16 8" stroke="#7F77DD" stroke-width="1.5" stroke-linecap="round" fill="none"/><path d="M7 12 Q12 7 17 12" stroke="#7F77DD" stroke-width="1.5" stroke-linecap="round" fill="none"/><path d="M6 16 Q12 10 18 16" stroke="#AFA9EC" stroke-width="1.5" stroke-linecap="round" fill="none"/></svg>',
    ck:       '<svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M12 4 L12 20" stroke="#534AB7" stroke-width="2" stroke-linecap="round"/><path d="M7 8 L12 12 L17 8" stroke="#7F77DD" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" fill="none"/><path d="M7 14 L12 18 L17 14" stroke="#AFA9EC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" fill="none"/></svg>',
  };
