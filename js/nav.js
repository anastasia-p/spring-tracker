...
function getSkillIcon(skill) {
  var icons = {
    ...
    forest_gump:  '<img src="images/forest_gump.png" style="width:100%;height:100%;object-fit:cover;border-radius:inherit">',
    dummy1:  '<span style="font-size:18px;font-family:serif;color:#534AB7;line-height:1">樁<sup style="font-size:10px;font-family:sans-serif">1</sup></span>',
  };
